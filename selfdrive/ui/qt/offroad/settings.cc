...
SettingsWindow::SettingsWindow(QWidget *parent) : QFrame(parent) {
  ...
  QList<QPair<QString, QWidget *>> panels = {
    ...
    {tr("Vehicle"), new CommunityPanel(this)},
  };
...
CommunityPanel::CommunityPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("RestartForceAccel",
                                            tr("Use Restart Force Accel"),
                                            tr("warnings: it is beta, be careful!! Force Accelereation when Re-starts with leading car"),
                                            "../assets/offroad/icon_road.png",
                                            this));


  toggles.append(new ParamControl("KeepLatWhenBrake",
                                            tr("Keep Lat control with Brakes"),
                                            tr("Brake will not disengage with this toggle"),
                                            "../assets/offroad/icon_openpilot.png",
                                            this));
