...
CommunityPanel::CommunityPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggleLayout->addWidget(new CValueControl("PowerOffTime", "PowerOffTime(O)", "0:Never Power Off,  X:Power Off after X Hours", "../assets/offroad/icon_shell.png", 0, 100, 1));
