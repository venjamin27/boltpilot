...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=None, experimental_long=False): # pylint: disable=dangerous-default-value
    ...
    # longitudinal
    ret.longitudinalTuning.kpBP = [0., 18.0 * CV.KPH_TO_MS, 130. * CV.KPH_TO_MS]
    ret.longitudinalTuning.kpV = [1.10, 1.0, 0.6]
    ret.longitudinalTuning.kiBP = [0., 18.0 * CV.KPH_TO_MS, 130. * CV.KPH_TO_MS]
    ret.longitudinalTuning.kiV = [0.145, 0.109, 0.085]
